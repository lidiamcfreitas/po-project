...
public class Manager implements Serializable {
    ...
    public void openFromTextData(String fname) throws FileNotFoundException, IOException, ClassNotFoundException, UserExistsE, EntryExistsE, UserUnknownE, AccessDeniedE, IsNotDirectoryE, EntryUnknownE, IsNotFileE{
        ...
        /*catch(ClassNotFoundException | IOException e ){}
		   ...
		   catch( IsNotDirectoryE e){
		    throw new IsNotDirectoryException();
		   }
		   catch (EntryUnknownE e){
		    throw new EntryUnknownException();
		   }
		   catch (IsNotFileE e){
    ...
    public List<String> listUsers() throws EntryUnknownE {
    ...
    public void createFile(String fname,String permission) throws AccessDeniedE, EntryExistsE{
    ...
    public void writeFile(String fname, String text) throws EntryUnknownE,IsNotFileE,AccessDeniedE{
        _activeFS.writeFile(fname, text, _workDir, _loggedIn);
        _change = true;
    }
    
    public List<String> seeFile(String fname) throws EntryUnknownE,IsNotFileE{
    ...
    public boolean hasFS() { return _activeFS!=null; }
    
    public boolean hasLoggedIn() { return _loggedIn!=null; }
