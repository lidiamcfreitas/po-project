...
public class FileSystem implements Serializable{
   ...
   public void createFile(String fname,String permission, Directory workDir, User loggedIn) throws  AccessDeniedE, EntryExistsE{
   ...
   public void writeFile(String fname, String text,Directory workDir, User loggedIn) throws  EntryUnknownE,IsNotFileE,AccessDeniedE{
   ...
   public List<String> seeFile(String fname,Directory workDir) throws EntryUnknownE,IsNotFileE{
	Entry e = workDir.getEntry(fname);
	if (e  instanceof File)
